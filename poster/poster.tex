...
\usepackage{lmodern}
\usepackage[size=custom,width=121,height=88,scale=1.0]{beamerposter} 
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Monte Carlo Simulation of CUPID array}
    \vspace{2cm}
...
\vspace{2cm}
    ...
    % \begin{figure}
    %   \centering
    %   \includegraphics[width=25cm]{~/research/figures/DNP2021/cupid_array.png}
    %   \caption{Rendering of the CUPID array}
    % \end{figure}
