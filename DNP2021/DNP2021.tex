...
%		\footcitetext{squid}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.5\textwidth} % Right column and width
			\includegraphics[width=5cm]{~/research/figures/DNP2021/scintillation.png}
			\includegraphics[width=5cm]{~/research/figures/DNP2021/lightyield.jpg}
		\end{columns}
	\end{frame}
...
%		\footcitetext{chernyak}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\includegraphics[width=6.5cm]{~/research/figures/DNP2021/gamma2.jpg}
%			\caption{gnarly}
