...
%	\end{frame}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.5\textwidth} % Right column and width
			\begin{figure}
			\includegraphics[width=\linewidth]{~/research/figures/DNP/scintillation.png}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.5\textwidth} % Right column and width
			\begin{figure}
			\includegraphics[width=\linewidth]{~/research/figures/DNP/muon_veto.png}
			%\caption{gnarly}
			\end{figure}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\includegraphics[width=\linewidth]{~/research/figures/DNP2021/compton_2pt6MeV.png}
			\caption{gnarly}
...
%------------------------------------------------
	...
	\begin{frame}
		\frametitle{2$\nu\beta\beta$ efficiency and the muon background}
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
