...
%	\end{frame}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.45\textwidth} % Left column and width
			%\textbf{Heading}
			standard model leptons $\textit{e}, \mu,\tau$ each have associated neutrinos $\nu_{\mu}, \nu_{\tau}$. 
			\begin{itemize}
				\setlength\itemsep{2em}
				\item Proposed
			\end{itemize}
			...
			\end{pmatrix}
			\end{gather*}
			$\implies$ lepton flavor conservation
			$\implies$ $\nu_{\alpha} \nleftrightarrow \nu_{\beta}$
	...
	\begin{frame}
		...
		\begin{columns}[c]
			\column{.45\textwidth}
			PMNS MATRIX -> what experiments are sensitive to which parts? can you highlight the separate parts	
	...
	\begin{frame}
		...
		\end{columns}
		\footcitetext{arxiv.org/abs/1904.05745}
	\end{frame}
...
\section{Status of the 0nbb searches}	
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\includegraphics[width=6.2cm]{~/research/figures/DNP2021/gamma2.jpg}
%			\caption{gnarly}
...
%------------------------------------------------
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.5\textwidth} % Right column and width
			\includegraphics[scale=0.2]{~/research/figures/DNP2021/cupid_array.png}
