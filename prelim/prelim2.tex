...
=======
			\begin{align*}
			\mathcal{L} = \frac{i}{2} \big[\bar{\psi}\gamma^{\mu}\left(\partial_{\mu}\psi\right) \\
			- \left(\partial_{\mu}\bar{\psi}\right)\gamma^{\mu}\psi \big] - \text{m}\bar{\psi}\psi \\
...
=======
		\frametitle{Majorana fermions, chirality, and mass}
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\begin{itemize}
				...
				\item Majorana fermions can be understood as particles of the Dirac Equation with an extra constraint on the spinors
				
				\item implies that majorana particles are chargeless and are their own antiparticles.
				\item 
			\end{itemize}
			...
			\begin{eqnarray*}
			hat{\psi} = \hat{\psi}^C \\
			1/2\left(\overline{\hat{\psi}}_L^C\hat{\psi}_L\right)
			\end{eqnarray*}
...
=======
				\item For neutrinos to be massive, there must be some mechanism beyond the standard model that can give them mass
...
%	\end{frame}		
	...
	\begin{frame}
		\frametitle{effective neutrino mass}
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\end{equation*}
			\begin{equation*}
			\langle m_{\beta\beta}\rangle = |U_{ej}^2 m_j|
			\end{equation*}}
	...
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\begin{itemize}
				...
				\item a figure of merit for $0\nu\beta\beta$ searches is the 'sensitivity'
			\end{itemize} 
...
=======
	\begin{frame}
		...
		\begin{columns}[c] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
			...
			\column{.5\textwidth} % Right column and width
			\includegraphics[width=\linewidth]{~/research/figures/prelim/2vbb_spectrum.png}
